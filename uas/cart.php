...
?>
  ...
  <h4>Your Order</h4>
  <p>Payment: </p>
  <p><input type='radio' name='cash' value='cash' /> Cash</p>
  <p><input type='radio' name='cashless' value='perempuan' /> Cashless</p>
  <table class="table table-bordered text-light">
    <tr align="center" style="background-color: #d06f6f;">
      <th>#</th>
      <th>Coffee</th>
      <th>Qty</th>
      <th>Price</th>
